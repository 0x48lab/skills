...
object CraftDifficulty {
    ...
    private val craftInfoMap: Map<Material, CraftInfo> = buildMap {
        ...
        put(Material.STONE_AXE, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.STONE_PICKAXE, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.STONE_SHOVEL, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.STONE_HOE, CraftInfo(SkillType.CRAFTING, 10))

        // Blacksmithy - Iron (difficulty aligned with iron ore mining: 25)
        put(Material.IRON_SWORD, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.IRON_AXE, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.IRON_PICKAXE, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.IRON_SHOVEL, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.IRON_HOE, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.IRON_HELMET, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.IRON_CHESTPLATE, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.IRON_LEGGINGS, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.IRON_BOOTS, CraftInfo(SkillType.CRAFTING, 25))

        // Blacksmithy - Gold (slightly easier than iron)
        put(Material.GOLDEN_SWORD, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GOLDEN_AXE, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GOLDEN_PICKAXE, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GOLDEN_SHOVEL, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GOLDEN_HOE, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GOLDEN_HELMET, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GOLDEN_CHESTPLATE, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GOLDEN_LEGGINGS, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GOLDEN_BOOTS, CraftInfo(SkillType.CRAFTING, 20))
        ...
        put(Material.DIAMOND_AXE, CraftInfo(SkillType.CRAFTING, 40))
        put(Material.DIAMOND_PICKAXE, CraftInfo(SkillType.CRAFTING, 40))
        put(Material.DIAMOND_SHOVEL, CraftInfo(SkillType.CRAFTING, 40))
        put(Material.DIAMOND_HOE, CraftInfo(SkillType.CRAFTING, 40))
        put(Material.DIAMOND_HELMET, CraftInfo(SkillType.CRAFTING, 40))
        put(Material.DIAMOND_CHESTPLATE, CraftInfo(SkillType.CRAFTING, 40))
        put(Material.DIAMOND_LEGGINGS, CraftInfo(SkillType.CRAFTING, 40))
        put(Material.DIAMOND_BOOTS, CraftInfo(SkillType.CRAFTING, 40))
        ...
        put(Material.CHAINMAIL_HELMET, CraftInfo(SkillType.CRAFTING, 30))
        put(Material.CHAINMAIL_CHESTPLATE, CraftInfo(SkillType.CRAFTING, 30))
        put(Material.CHAINMAIL_LEGGINGS, CraftInfo(SkillType.CRAFTING, 30))
        put(Material.CHAINMAIL_BOOTS, CraftInfo(SkillType.CRAFTING, 30))

        // Blacksmithy - Other
        put(Material.ANVIL, CraftInfo(SkillType.CRAFTING, 35))
        put(Material.MACE, CraftInfo(SkillType.CRAFTING, 50))

        // Bows and Arrows (now part of Craftsmanship)
        put(Material.BOW, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.CROSSBOW, CraftInfo(SkillType.CRAFTING, 30))
        put(Material.ARROW, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.SPECTRAL_ARROW, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.TIPPED_ARROW, CraftInfo(SkillType.CRAFTING, 25))
        ...
        put(Material.WOODEN_AXE, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.WOODEN_PICKAXE, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.WOODEN_SHOVEL, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.WOODEN_HOE, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.SHIELD, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.CHEST, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.TRAPPED_CHEST, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.BARREL, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.BOOKSHELF, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.CHISELED_BOOKSHELF, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.CRAFTING_TABLE, CraftInfo(SkillType.CRAFTING, 3))
        put(Material.LOOM, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.CARTOGRAPHY_TABLE, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.FLETCHING_TABLE, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.SMITHING_TABLE, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.COMPOSTER, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.LECTERN, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.JUKEBOX, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.NOTE_BLOCK, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.LADDER, CraftInfo(SkillType.CRAFTING, 3))
        put(Material.BOWL, CraftInfo(SkillType.CRAFTING, 2))
        put(Material.ITEM_FRAME, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.GLOW_ITEM_FRAME, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.PAINTING, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.ARMOR_STAND, CraftInfo(SkillType.CRAFTING, 15))
        ...
        put(Material.OAK_BOAT, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.SPRUCE_BOAT, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.BIRCH_BOAT, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.JUNGLE_BOAT, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.ACACIA_BOAT, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.DARK_OAK_BOAT, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.MANGROVE_BOAT, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.CHERRY_BOAT, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.BAMBOO_RAFT, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.OAK_CHEST_BOAT, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.SPRUCE_CHEST_BOAT, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.BIRCH_CHEST_BOAT, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.JUNGLE_CHEST_BOAT, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.ACACIA_CHEST_BOAT, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.DARK_OAK_CHEST_BOAT, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.MANGROVE_CHEST_BOAT, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.CHERRY_CHEST_BOAT, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.BAMBOO_CHEST_RAFT, CraftInfo(SkillType.CRAFTING, 12))

        // Craftsmanship - Beds (all colors)
        put(Material.WHITE_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.ORANGE_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.MAGENTA_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.LIGHT_BLUE_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.YELLOW_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.LIME_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.PINK_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.GRAY_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.LIGHT_GRAY_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.CYAN_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.PURPLE_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.BLUE_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.BROWN_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.GREEN_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.RED_BED, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.BLACK_BED, CraftInfo(SkillType.CRAFTING, 8))

        // Craftsmanship - Banners (all colors)
        put(Material.WHITE_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.ORANGE_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.MAGENTA_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.LIGHT_BLUE_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.YELLOW_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.LIME_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.PINK_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.GRAY_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.LIGHT_GRAY_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.CYAN_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.PURPLE_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.BLUE_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.BROWN_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.GREEN_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.RED_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.BLACK_BANNER, CraftInfo(SkillType.CRAFTING, 10))
        ...
        put(Material.LEATHER_HELMET, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.LEATHER_CHESTPLATE, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.LEATHER_LEGGINGS, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.LEATHER_BOOTS, CraftInfo(SkillType.CRAFTING, 15))
        ...
        put(Material.PISTON, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.STICKY_PISTON, CraftInfo(SkillType.CRAFTING, 28))
        put(Material.DISPENSER, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.DROPPER, CraftInfo(SkillType.CRAFTING, 22))
        put(Material.OBSERVER, CraftInfo(SkillType.CRAFTING, 30))
        put(Material.HOPPER, CraftInfo(SkillType.CRAFTING, 28))
        put(Material.REPEATER, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.COMPARATOR, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.LEVER, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.TRIPWIRE_HOOK, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.DAYLIGHT_DETECTOR, CraftInfo(SkillType.CRAFTING, 30))
        put(Material.TARGET, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.REDSTONE_TORCH, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.REDSTONE_LAMP, CraftInfo(SkillType.CRAFTING, 18))
        put(Material.TNT, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.SCULK_SENSOR, CraftInfo(SkillType.CRAFTING, 40))
        put(Material.CALIBRATED_SCULK_SENSOR, CraftInfo(SkillType.CRAFTING, 45))

        // Craftsmanship - Rails
        put(Material.RAIL, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.POWERED_RAIL, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.DETECTOR_RAIL, CraftInfo(SkillType.CRAFTING, 22))
        put(Material.ACTIVATOR_RAIL, CraftInfo(SkillType.CRAFTING, 22))
        put(Material.MINECART, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.CHEST_MINECART, CraftInfo(SkillType.CRAFTING, 22))
        put(Material.FURNACE_MINECART, CraftInfo(SkillType.CRAFTING, 22))
        put(Material.HOPPER_MINECART, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.TNT_MINECART, CraftInfo(SkillType.CRAFTING, 28))
        ...
        put(Material.STONECUTTER, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.FURNACE, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.BLAST_FURNACE, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.SMOKER, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GRINDSTONE, CraftInfo(SkillType.CRAFTING, 20))
        ...
        put(Material.ENDER_CHEST, CraftInfo(SkillType.CRAFTING, 50))
        put(Material.ENCHANTING_TABLE, CraftInfo(SkillType.CRAFTING, 55))
        put(Material.BEACON, CraftInfo(SkillType.CRAFTING, 80))
        put(Material.RESPAWN_ANCHOR, CraftInfo(SkillType.CRAFTING, 60))
        put(Material.LODESTONE, CraftInfo(SkillType.CRAFTING, 55))
        put(Material.CONDUIT, CraftInfo(SkillType.CRAFTING, 65))

        // Craftsmanship - Compressed blocks
        put(Material.SLIME_BLOCK, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.HONEY_BLOCK, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.HONEYCOMB_BLOCK, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.HAY_BLOCK, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.DRIED_KELP_BLOCK, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.BONE_BLOCK, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.MELON, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.SNOW_BLOCK, CraftInfo(SkillType.CRAFTING, 5))
        put(Material.MAGMA_BLOCK, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.PACKED_ICE, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.BLUE_ICE, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.MOSS_BLOCK, CraftInfo(SkillType.CRAFTING, 8))
        put(Material.NETHER_WART_BLOCK, CraftInfo(SkillType.CRAFTING, 12))
        put(Material.WARPED_WART_BLOCK, CraftInfo(SkillType.CRAFTING, 12))
        ...
        put(Material.FIREWORK_STAR, CraftInfo(SkillType.CRAFTING, 25))
        put(Material.END_CRYSTAL, CraftInfo(SkillType.CRAFTING, 50))
        put(Material.RECOVERY_COMPASS, CraftInfo(SkillType.CRAFTING, 45))

        // Blacksmithy - Storage blocks (metal compression)
        put(Material.IRON_BLOCK, CraftInfo(SkillType.CRAFTING, 20))
        put(Material.GOLD_BLOCK, CraftInfo(SkillType.CRAFTING, 18))
        put(Material.DIAMOND_BLOCK, CraftInfo(SkillType.CRAFTING, 35))
        put(Material.EMERALD_BLOCK, CraftInfo(SkillType.CRAFTING, 40))
        put(Material.LAPIS_BLOCK, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.REDSTONE_BLOCK, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.COAL_BLOCK, CraftInfo(SkillType.CRAFTING, 10))
        put(Material.NETHERITE_BLOCK, CraftInfo(SkillType.CRAFTING, 55))
        put(Material.RAW_IRON_BLOCK, CraftInfo(SkillType.CRAFTING, 18))
        put(Material.RAW_GOLD_BLOCK, CraftInfo(SkillType.CRAFTING, 18))
        put(Material.RAW_COPPER_BLOCK, CraftInfo(SkillType.CRAFTING, 15))
        put(Material.AMETHYST_BLOCK, CraftInfo(SkillType.CRAFTING, 20))
