...
enum class MessageKey(val path: String) {
    ...
    THIEF_TOO_FAR("thief.too_far"),
    THIEF_STEAL_SKILL_TOO_LOW("thief.steal_skill_too_low"),
    THIEF_STEAL_EQUIP_SKILL_TOO_LOW("thief.steal_equip_skill_too_low"),
    ...
    COMBAT_BACKSTAB("combat.backstab"),
    ...
    PARTY_INVITE_ACCEPT("party.invite_accept"),
    PARTY_INVITE_DECLINE("party.invite_decline"),
    PARTY_INVITE_DECLINE_CONFIRM("party.invite_decline_confirm"),
    PARTY_INVITE_DECLINED("party.invite_declined"),
    ...
    PARTY_MEMBER_KICKED("party.member_kicked"),
    PARTY_DISBANDED("party.disbanded"),
    PARTY_LEADER_CHANGED("party.leader_changed"),
    PARTY_FULL("party.full"),
    PARTY_ALREADY_IN("party.already_in"),
    PARTY_NOT_IN("party.not_in"),
    PARTY_NOT_LEADER("party.not_leader"),
    PARTY_TARGET_ALREADY_IN("party.target_already_in"),
    PARTY_TARGET_NOT_MEMBER("party.target_not_member"),
    PARTY_TARGET_OFFLINE("party.target_offline"),
    PARTY_SELF_INVITE("party.self_invite"),
    PARTY_SELF_KICK("party.self_kick"),
    PARTY_NO_INVITE("party.no_invite"),
    PARTY_LIST_HEADER("party.list_header"),
    PARTY_LIST_ENTRY("party.list_entry"),
    PARTY_LIST_ENTRY_OFFLINE("party.list_entry_offline"),
    PARTY_LIST_LEADER("party.list_leader"),
    PARTY_CHAT("party.chat"),
    PARTY_TP_START("party.tp_start"),
    PARTY_TP_SUCCESS("party.tp_success"),
    PARTY_TP_CANCELLED("party.tp_cancelled"),
    PARTY_TP_COOLDOWN("party.tp_cooldown"),
    PARTY_TP_DIFFERENT_WORLD("party.tp_different_world"),
    PARTY_TP_IN_COMBAT("party.tp_in_combat"),
    PARTY_SNOOP_BLOCKED("party.snoop_blocked"),
    PARTY_STEAL_BLOCKED("party.steal_blocked"),
